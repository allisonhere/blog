...
<aside id="toggle-sidebar" class="mobile-navigation toggle-sidebar sidebar sidebar-2" aria-label="<?php esc_attr_e( 'Blog Sidebar', 'mozda' ); ?>">
	...
	<div class="toggle-sidebar-header">
		...
		<div class="close-menu"><span><?php echo esc_html__('close', 'mozda' ); ?></span></div>
	</div>
