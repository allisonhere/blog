...
color:' . get_theme_mod( $value . '_widget_button_color', '' ) . ';}' : '' );
		...
		if ( $categories || $tags || $shop_categories ) :
			...
			if ( $categories ) {
				...
				// Widget/sub-category styling.
				$widget_base_css = '';
				$widget_color    = mozda_normalize_hex_color( get_theme_mod( 'category_slug_color', '' ) );
				$widget_bg       = mozda_normalize_hex_color( get_theme_mod( 'category_slug_background', '' ) );
				...
				$widget_dark_css  = '';
				$widget_dark_color = mozda_normalize_hex_color( get_theme_mod( 'category_slug_color_dark', '' ) );
				$widget_dark_bg    = mozda_normalize_hex_color( get_theme_mod( 'category_slug_background_dark', '' ) );
