...
function tfm_custom_color_scheme() {
		...
		// Body
		// ========================================================
		// $custom_css[] = ( '' !== get_theme_mod( 'tfm_body_background_color', '' ) ? '--body-background:' . get_theme_mod( 'tfm_body_background_color', '' ) . ';' : '' );
		// $custom_css[] = ( '' !== get_theme_mod( 'tfm_header_color', '' ) ? '--header-color:' . get_theme_mod( 'tfm_header_color', '' ) . ';' : '' );
		// $custom_css[] = ( '' !== get_theme_mod( 'tfm_header_elements_background', '' ) ? '--header-elements-background:' . get_theme_mod( 'tfm_header_elements_background', '' ) . ';' : '' );
		// $custom_css[] = ( '' !== get_theme_mod( 'tfm_header_elements_color', '' ) ? '--header-elements-color:' . get_theme_mod( 'tfm_header_elements_color', '' ) . ';' : '' );
		...
		$custom_css[] = ( '' !== get_theme_mod( 'tfm_entry_title_link_color', '' ) ? '--entry-title-color:' . get_theme_mod( 'tfm_entry_title_link_color', '' ) . ';' : '' );
		...
		$custom_css[] = ( '' !== get_theme_mod( 'tfm_cover_format_primary_color', '' ) ? '--cover-primary-color:' . get_theme_mod( 'tfm_cover_format_primary_color', '' ) . ';' : '' );
		...
		// General Settings
		// ========================================================
		$custom_css[] = ( get_theme_mod( 'tfm_site_width', $customizer_settings['site_width'] ) !== $customizer_settings['site_width'] ? '--site-width:' . get_theme_mod( 'tfm_site_width', $customizer_settings['site_width'] ) . 'px; --site-max-width: ' . get_theme_mod( 'tfm_site_width', $customizer_settings['site_width'] ) . 'px;' : '' );
...
color:' . get_theme_mod( $value . '_widget_button_color', '' ) . ';}' : '' );
		...
		if ( count($widget_colors) !== 0 ) :
			...
			echo '<style type="text/css" id="mozda-widget-css">';
		...
		if ( $categories || $tags || $shop_categories) :
			...
			if ( $categories ) {
				...
				$slug_color = '' !== get_theme_mod( 'category_slug_color', '' ) ? 'color:' . get_theme_mod( 'category_slug_color', '' ) . ';' : '';
				...
				$slug_background = '' !== get_theme_mod( 'category_slug_background_' . $value->slug . '', '' ) ? 'background:' . get_theme_mod( 'category_slug_background_' . $value->slug . '', '' ) . '; border: 0 !important;' : '';

					$custom_slug_color[] =  ( $slug_color || $slug_background ? '.entry-meta a.cat-link-' . $value->term_id . ' { ' . $slug_color . $slug_background . '} .widget a.tag-link-' . $value->term_id . ', .sub-categories a.cat-link-' . $value->term_id . ' { ' . $slug_color . $slug_background . ' }' : '' );
